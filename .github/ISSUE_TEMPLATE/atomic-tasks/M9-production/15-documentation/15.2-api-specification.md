...
# Task 15.2: API Specification and Interactive Documentation
...
- [ ] **HTTP Client Examples**
  ...
  response = requests.get('https://api.example.com/api/v2/search', params={
      'q': 'آموزش برنامه‌نویسی',  # Persian query
      'limit': 10
  })
  ...
  // Usage
  search('یادگیری عمیق').then(results => {
...
### Common Pitfalls
- ❌ Spec diverges from actual API implementation
- ❌ Missing or incorrect example requests/responses
